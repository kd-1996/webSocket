 ...
 * for it, but we can choose any other messaging Protocol such as RabbitMQ or ActiveMQ.
 */
...
public class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer {
  ...
  public void registerStompEndpoints(StompEndpointRegistry registry) {
    ...
    //This is the webSocket which will be created for us. You can add multiple end points Sock-js
    // library to create webSockets
  }
}
